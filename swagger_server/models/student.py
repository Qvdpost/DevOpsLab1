...
from swagger_server.models.one_of_student_grade_records_items import OneOfStudentGradeRecordsItems  # noqa: F401,E501
...
class Student(Model):
    ...
    """
    def __init__(self, student_id: int=None, first_name: str=None, last_name: str=None, grade_records: List[OneOfStudentGradeRecordsItems]=None):  # noqa: E501
        ...
        :type grade_records: List[OneOfStudentGradeRecordsItems]
        """
        self.swagger_types = {
            'student_id': int,
            'first_name': str,
            'last_name': str,
            'grade_records': List[OneOfStudentGradeRecordsItems]
        }
    ...
    @property
    def grade_records(self) -> List[OneOfStudentGradeRecordsItems]:
        """Gets the grade_records of this Student.


        :return: The grade_records of this Student.
        :rtype: List[OneOfStudentGradeRecordsItems]
        """
        return self._grade_records

    @grade_records.setter
    def grade_records(self, grade_records: List[OneOfStudentGradeRecordsItems]):
